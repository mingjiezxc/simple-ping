...
// @Produce json
// @Success 200 {object} JobStruct "Success"
// @Failure 201 {string} string "request data err"
// @Failure 202 {string} string "redis connect err"
// @Failure 203 {string} string "redis connect err"
// @Router /job [post]
func JobAdd(c *gin.Context) {
	...
	if PrintErr(err) {
		c.JSON(203, BaseReturn{Status: false, Data: err})
		return
	}
